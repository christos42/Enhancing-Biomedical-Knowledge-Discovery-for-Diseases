...
DEFAULT_UMLS_PATH = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/umls_2022_ab.jsonl"  # noqa
#DEFAULT_UMLS_PATH = "https://s3-us-west-2.amazonaws.com/ai2-s2-scispacy/data/kbs/2020-10-09/umls_2020_aa_cat0129.jsonl"  # noqa
DEFAULT_UMLS_TYPES_PATH = "/cw/liir_data/NoCsBack/christos/knowledge_bases/umls_semantic_type_tree.tsv"
...
class Mesh(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/mesh_umls_2022_ab.jsonl",  # noqa
...
class GeneOntology(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/go_umls_2022_ab.jsonl",  # noqa
...
class HumanPhenotypeOntology(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/hpo_umls_2022_ab.jsonl",  # noqa
        #file_path: str = "https://ai2-s2-scispacy.s3-us-west-2.amazonaws.com/data/kbs/2020-10-09/umls_2020_hpo.jsonl"
    ):
        super().__init__(file_path)
...
class RxNorm(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/rxnorm_umls_2022_ab.jsonl",  # noqa
        #file_path: str = "https://ai2-s2-scispacy.s3-us-west-2.amazonaws.com/data/kbs/2020-10-09/umls_2020_rxnorm.jsonl"
    ):
        super().__init__(file_path)


class DrugBank(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/drugbank_umls_2022_ab.jsonl",  # noqa
    ):
        super().__init__(file_path)


class GoldStandardDrug(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/gs_umls_2022_ab.jsonl",  # noqa
    ):
        super().__init__(file_path)


class Ncbi(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/ncbi_umls_2022_ab.jsonl",  # noqa
    ):
        super().__init__(file_path)


class Snomed(KnowledgeBase):
    def __init__(
        self,
        file_path: str = "/cw/liir_data/NoCsBack/christos/knowledge_bases/vocabularies/snomed_umls_2022_ab.jsonl",  # noqa
    ):
        super().__init__(file_path)
