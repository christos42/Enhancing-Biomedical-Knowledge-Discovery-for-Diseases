                            ...
                            for k6 in self.res_dict[k1][k2][k3][k4][k5].keys():
                                for k7 in self.res_dict[k1][k2][k3][k4][k5][k6].keys():
                                    try:
                                        ...
                                        self.res_dict[k1][k2][k3][k4][k5][k6][k7]['std_f1'] = round(
                                            statistics.stdev(self.res_dict[k1][k2][k3][k4][k5][k6][k7]['f1']), 4)
                                    except:
                                        pass
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_models_path", default='results_original_split/', type=str, required=False,
                        help="The path of the saved models.")
    parser.add_argument("--output_path", default='results_original_split/', type=str, required=False,
